...
const appDescription = "test project"

func main() {
	app := cli.App("cookiecutter_service", appDescription)

	appSystemCode := app.String(cli.StringOpt{
		Name:   "app-system-code",
		Value:  "cookiecutter_system_code",
	...
	log.Infof("[Startup] cookiecutter_service is starting ")
...
func serveEndpoints(appSystemCode string, appName string, port string, requestHandler requestHandler) {
	...
	waitForSignal()
	log.Infof("[Shutdown] cookiecutter_service is shutting down")
